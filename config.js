...
(function () {
  ...
  const rootControls = {
    ...
    items: {
      ...
      widgetControls: {
        sticker: {
          "popup.duplicate": true,
          "popup.sequence": true,
          "popup.group": true,
          "popup.bring-forward": true,
          "popup.send-backward": true,
          "popup.delete": true,
          "text.fill": true,
          "text.border": true,
          "text.border-size": true,
          "text.border-color": true,
          "text.font": true,
          "text.size": true,
          "text.style": true,
          "text.align": true,
      ...
      palettes: {
        gray: {
          ...
          colors: [
            ...
            {
              label: "666",
              value: "var(--color-gray2)",
              ink: "var(--color-white)",
            },
            {
              label: "333",
              value: "var(--color-gray1)",
              ink: "var(--color-white)",
            },
            {
              label: "000",
